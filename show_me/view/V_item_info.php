        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="block">
            <div class="flexbox">
              ...
              <div class="flex_3">
                <input type="text" class="text_width" name="item_name" value="<?php print $item_name?>">
              </div>
            </div>
            <p class="tips inline_center_width">商品名は 100文字以内 で入力してください</p>
          </div>
          ...
          <div class="block">
            <div class="flexbox">
              <div class="flex_1 subject">
                <div class="flexbox">
                  <p class="must block_center_height">(必須)</p>
                  <p class="block_center_height">価格</p>
                </div>
              </div>
              <div class="flex_3">
                <input type="number" class="text_width" name="price" value="<?php print $price?>">
              </div>
            </div>
          </div>
          ...
          <div class="block">
            <div class="flexbox">
              <div class="flex_1 subject">
                <div class="flexbox">
                  <p class="must block_center_height">(必須)</p>
                  <p class="block_center_height">公開状況</p>
                </div>
              </div>
              <div class="flex_3">
          ...
          <div class="block">
            <div class="flexbox">
              <div class="flex_1 subject">
                <div class="flexbox">
                  <p class="must block_center_height">(必須)</p>
                  <p class="block_center_height">在庫</p>
                </div>
              </div>
              <div class="flex_3">
                <input type="number" class="text_width" name="stock" value="<?php print $stock?>">
              </div>
            </div>
          </div>
          ...
          <div class="block">
            ...
            <div class="flexbox">
              <div class="flex_1 subject">
                <p class="block_center_height">商品サムネイル</p>
              </div>
              <div class="flex_3">
          ...
          <div class="block">
            <div class="flexbox">
              <div class="flex_1 subject">
                <div class="flexbox">
                  <p class="must block_center_height">(必須)</p>
                  <p class="block_center_height">メインカテゴリ</p>
                </div>
              </div>
              <div class="flex_3">
                <?php
